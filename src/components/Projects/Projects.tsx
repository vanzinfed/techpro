    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 projects-header">
          <h2 className="projects-title relative inline-block" style={{fontFamily: 'Onest, sans-serif', fontWeight: 900, fontSize: 'clamp(28px, 5vw, 48px)', color: '#2563EB', textAlign: 'center', lineHeight: 1, marginBottom: 28}}>
            НАШИ <span style={{color: '#333'}}>ПРОЕКТЫ</span>
          </h2>
          ...
          {projects.map((project) => (
            <div key={project.id} className="project-card bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl group">
              ...
              <div className="project-info p-4 sm:p-6 text-left">
                <h3 className="font-bold text-[18px] sm:text-[20px] text-[#333] mb-2" style={{fontFamily: 'Onest, sans-serif', textAlign: 'left'}}>{project.title}</h3>
